/*
  ...
  - A unique constraint covering the columns `[id]` on the table `user_role` will be added. If there are existing duplicate values, this will fail.

*/
-- DropIndex
DROP INDEX `user_role_id_user_id_role_id_key` ON `user_role`;
