        ...
        <div className="flex justify-between">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={hamburgerMenuOpened ? "M6 18L18 6M6 6l12 12" : "M4 6h16M4 12h16M4 18h16"} />
            </svg>
          </button>
        </div>
        <ul className={`flex-1 justify-between mt-12 md:flex md:mt-0 ${hamburgerMenuOpened ? '' : 'hidden'}`}>
          <li className="order-2 pb-5 md:pb-0">
            <a href="/api/auth/signin" className="py-3 px-6 rounded-md shadow-md text-white text-center bg-blue-600 focus:shadow-none block md:inline">
              Sign In
            </a>
          </li>
