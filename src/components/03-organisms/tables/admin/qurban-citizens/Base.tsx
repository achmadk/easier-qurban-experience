...
export interface TableAdminQurbanCitizensBaseProps<
...
const TableAdminQurbanCitizensBase = <
  DataType extends ICitizenWithID = ICitizenWithID,
  PropType extends TableAdminQurbanCitizensBaseProps<DataType> = TableAdminQurbanCitizensBaseProps<DataType>
        ...
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          <div className="flex flex-wrap items-center">
            ...
            <div
              ...
              <Link
                href={`/admin/mosques/${mosqueId}/events/${qurbanEventId}/citizens`}
                legacyBehavior>
                <a
...
export const TableAdminQurbanCitizens = addRefProps(
  TableAdminQurbanCitizensBase
)
